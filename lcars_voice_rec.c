...
typedef int (*Fn_vosk_recognizer_accept_waveform)(VoskRecognizer *recognizer,
                                                  const char *data, int length);
typedef const char *(*Fn_vosk_recognizer_result)(VoskRecognizer *recognizer);
typedef const char *(*Fn_vosk_recognizer_partial_result)(
    VoskRecognizer *recognizer);
typedef const char *(*Fn_vosk_recognizer_final_result)(
    VoskRecognizer *recognizer);
...
static Fn_vosk_recognizer_accept_waveform p_vosk_recognizer_accept_waveform =
    NULL;
static Fn_vosk_recognizer_result p_vosk_recognizer_result = NULL;
static Fn_vosk_recognizer_partial_result p_vosk_recognizer_partial_result =
    NULL;
...
static bool LoadVoskLibrary(void) {
  ...
  *(void **)(&p_vosk_recognizer_new) =
      dlsym(g_vosk_handle, "vosk_recognizer_new");
  *(void **)(&p_vosk_recognizer_free) =
      dlsym(g_vosk_handle, "vosk_recognizer_free");
  *(void **)(&p_vosk_recognizer_accept_waveform) =
      dlsym(g_vosk_handle, "vosk_recognizer_accept_waveform");
  *(void **)(&p_vosk_recognizer_result) =
      dlsym(g_vosk_handle, "vosk_recognizer_result");
  *(void **)(&p_vosk_recognizer_partial_result) =
      dlsym(g_vosk_handle, "vosk_recognizer_partial_result");
  *(void **)(&p_vosk_recognizer_final_result) =
      dlsym(g_vosk_handle, "vosk_recognizer_final_result");

  if (!p_vosk_model_new || !p_vosk_model_free || !p_vosk_recognizer_new ||
      !p_vosk_recognizer_free || !p_vosk_recognizer_accept_waveform ||
      !p_vosk_recognizer_result || !p_vosk_recognizer_partial_result ||
      !p_vosk_recognizer_final_result) {
    fprintf(stderr,
            "VoiceRec: Failed to find all Vosk symbols in libvosk.so\n");
...
static void QueueResultText(const char *text) {
  ...
  strncpy(g_resultQueue[g_resultHead], text,
...
static void AudioCaptureCallback(ma_device *pDevice, void *pOutput,
